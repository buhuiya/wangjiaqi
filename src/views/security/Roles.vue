  ...
  <div class="role-container">
    <el-card shadow="never">
      <div class="role-header">
        <div class="button-container"><el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd">
            新增
          </el-button>
        </div>
      </div>
      ...
      <div class="role-body">
        <el-table :data="roleList"
          ...
          ref="table" row-key="id" style="width: 100%" size="medium">
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <el-button @click="handleUpdate(scope.row)" type="text" size="small">编辑角色</el-button>
              <el-button
    ...
    <el-dialog :title="dialogTitle" width="500px" :visible="dialogShow" :before-close="handleClose">
      <el-form>
    ...
    <!--  分配权限对话框  -->
    <el-dialog title="分配权限" width="500px" :visible="permissoionDialog" :before-close="handleClosePermission">
      <el-tree ref="tree" :data="permissionData" show-checkbox node-key="id"
        style="margin-bottom: 20px" check-on-click-node
        check-strictly>
